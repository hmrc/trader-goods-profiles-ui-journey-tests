...
package uk.gov.hmrc.test.ui.specpages.Categorisation
...
object CategorisationStandardGoodsCompletePage extends BasePage {

  def title: String = "Standard goods"
  def h1: String    = "Standard goods"
