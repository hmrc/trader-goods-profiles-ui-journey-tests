...
import uk.gov.hmrc.test.ui.specpages.Categorisation.{CategorisationCategory1CompletePage, CategorisationCategory2CompletePage, CategorisationStandardGoodsCompletePage}

object CategorisationCompleteSteps {

  // ^(?:I )?should be on the 'Categorisation complete' with (.+) page$
  def shouldBeOnCategorisationCompletePage(panelBody: String): Unit = {
    panelBody match {
