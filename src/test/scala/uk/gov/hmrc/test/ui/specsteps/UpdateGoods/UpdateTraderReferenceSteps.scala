...
import uk.gov.hmrc.test.ui.specpages.UpdateGoods.{UpdateTraderReferenceCYAPage, UpdateTraderReferencePage}
import java.util.UUID

object UpdateTraderReferenceSteps {

  // ^(?:I )?should be on the 'Product reference' update page$
  def shouldBeOnProductReferenceUpdatePage(): Unit = {
    UpdateTraderReferencePage
          .assertPage()
  }

  // ^(?:I )?should be on the 'Product reference' update CYA page$
  def shouldBeOnProductReferenceUpdateCYAPage(): Unit = {
    UpdateTraderReferenceCYAPage
          .assertPage()
  }

  // ^(?:I )?enter (.*) Product reference update$
  def enterProductReferenceUpdate(traderReference: String): Unit = {
