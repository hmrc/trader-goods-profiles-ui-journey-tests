...
object UpdateGoodsSupplementaryUnitPage extends Page {
  ...
  override def url(args: String*): String   = "/update-record/" + recordId + "/categorisation/supplementary-unit-amount/update/"
}
